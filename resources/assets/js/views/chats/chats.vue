                    ...
                    <div class="g-chat">
                      ...
                      <div v-if="chatHeadPhone" class="g-chat-message">
                        ...
                        <label for="s-msg" class="w-100">
                                                  <textarea data-vv-as="Message" name="message" v-model="message"
  ...
  methods: {
    ...
    toggleFullScreen() {
      ...
      if (!document.fullscreenElement && !document.webkitFullscreenElement) {
        ...
        chatBody.style.height = 'calc(100vh - 125px)';
        chatLeft.style.height = 'calc(100vh - 125px)';
        chatHistory.style.height = 'calc(100vh - 315px)';
      } else {
        document.exitFullscreen();
        chatArea.style.minHeight = '65vh';
        chatBody.style.height = 'calc(65vh - 30px)';
        chatLeft.style.height = 'calc(65vh - 30px)';
        chatHistory.style.height = 'calc(65vh - 215px)';
      }
